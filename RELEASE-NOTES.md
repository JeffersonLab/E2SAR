...
- BREAKING: Deprecated ReassemblerFlags.withLBHeader - the field has been removed, instead the logic uses the useCP flag to determine whether to expect (useCP==false) or not to expect (useCP==true) the LB header in the received packets.
